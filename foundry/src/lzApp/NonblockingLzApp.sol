...
import {ExcessivelySafeCall} from "src/utils/ExcessivelySafeCall.sol";
...
abstract contract NonblockingLzApp is LzApp {
    ...
    error NonblockingLzApp__INVALID_INTERNAL_CALLER();
    ...
    function nonblockingLzReceive(
        ...
        if (_msgSender() != address(this)) {
            revert NonblockingLzApp__INVALID_INTERNAL_CALLER();
        }
