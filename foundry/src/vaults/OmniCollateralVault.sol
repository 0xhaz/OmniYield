...
/**
 * @title OmniCollateralVault
 * @notice Implements The Collateral Vault for use in the Omni Yield system
 * @notice Holds collateral assets for the Omni Yield system and put it under EVC control
 */
contract OmniCollateralVault is OmniBaseVault {
